...
public class AmirRecruiting extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_amir_recruiting);
        ...
        call.enqueue(new Callback<ResponseBody>() {
            ...
            public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    Toast.makeText(AmirRecruiting.this, "Server is down", Toast.LENGTH_SHORT).show();
                }
            }
...
//                DATA_TO_SHOW[i][5] = occupation;
            ...
            Intent i = new Intent(AmirRecruiting.this, WorkerReport.class);
            ...
            public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                ...
                if (response.isSuccessful()) {
                    try {
                        ...
                        jo2 = jsonRESULTS.getJSONArray("amir_r_completed");
